                            ...
                            <div class="row">
                                <div class="col-lg-8">
                                    <div class="border border-3 p-4 rounded">
                                        ...
                                        <div class="mb-3">
                                            <label for="product_long_description" class="form-label">Description <span class="text-danger">*</span></label>
                                        ...
                                        <div class="row mb-3">
                                            <label for="product_image" class="form-label">Product Thumnail <span class="text-danger">*</span></label>
                                            <div class="col-sm-9 text-secondary">
                                                <div class="row">
                                                    <div class="col-sm-8 text-secondary">
                                                        <input class="form-control" type="file" name="product_image"
                                                            id="product_image" onchange="thumnailImage(this)">
                                                        @error('product_image')
                                                            <span class="text text-danger">{{ $message }}</span>
                                                        @enderror
                                                    </div>
                                        ...
                                        <div class="row mb-3">
                                            <label for="image_one" class="form-label">Product Extra image 1 <span class="text-danger">*</span></label>
                                            <div class="col-sm-9 text-secondary">
                                                <div class="row">
                                                    <div class="col-sm-8 text-secondary">
                                                        <input class="form-control" type="file" name="image_one" id="image_one"
                                                        onchange="extraimg1(this)" >
                                                        @error('image_one')
                                                        <span class="text text-danger">{{ $message }}</span>
                                                        @enderror
                                                    </div>
                                        ...
                                        {{-- pruduct extra image one end  --}}
                                          ...
                                          <div class="row mb-3">
                                            <label for="image_two" class="form-label">Product Extra image 2 <span class="text-danger">*</span></label>
                                            <div class="col-sm-9 text-secondary">
                                                <div class="row">
                                                    <div class="col-sm-8 text-secondary">
                                                        <input class="form-control" type="file" name="image_two" id="image_two"
                                                        onchange="extraimg2(this)" >
                                                        @error('image_two')
                                                        <span class="text text-danger">{{ $message }}</span>
                                                        @enderror
                                                    </div>
                                        ...
                                        <div class="row mb-3">
                                            <label for="image_three" class="form-label">Product Extra image 3 <span class="text-danger">*</span></label>
                                            <div class="col-sm-9 text-secondary">
                                                <div class="row">
                                                    <div class="col-sm-8 text-secondary">
                                                        <input class="form-control" type="file" name="image_three" id="image_three"
                                                        onchange="extraimg3(this)" >
                                                        @error('image_three')
                                                        <span class="text text-danger">{{ $message }}</span>
                                                        @enderror
                                                    </div>
                                        ...
                                        <div class="row mb-3">
                                            <label for="image_four" class="form-label">Product Extra image 4 <span class="text-danger">*</span></label>
                                            <div class="col-sm-9 text-secondary">
                                                <div class="row">
                                                    <div class="col-sm-8 text-secondary">
                                                        <input class="form-control" type="file" name="image_four" id="image_four"
                                                        onchange="extraimg4(this)" >
                                                        @error('image_four')
                                                        <span class="text text-danger">{{ $message }}</span>
                                                        @enderror
                                                    </div>
                                ...
                                <div class="col-lg-4">
                                    <div class="border border-3 p-4 rounded">
                                        <div class="row g-3">
                                            ...
                                            <div class="col-12">
                                                <label for="inputProductTags" class="form-label">Product quantity <span class="text-danger">*</span></label>
                                            ...
                                            <div class="col-12">
                                                <div class="form-check">
                                                    <input class="form-check-input" type="checkbox" value="1" name="Feature_product" id="Feature_product">
                                                    <label class="form-check-label" for="Feature_product">Feature_product</label>
                                                </div>
                                            </div>
    
                                            <div class="col-12">
                                                <div class="form-check">
                                                    <input class="form-check-input" type="checkbox" value="1" name="product_collection" id="product_collection">
                                                    <label class="form-check-label" for="product_collection">product_collection</label>
                                                </div>
                                            </div>
...
<script type="text/javascript">
    function extraimg1(input) {
        if (input.files && input.files[0]) {
            var reader = new FileReader();
            reader.onload = function(e) {
                $('#image_one_preview').attr('src', e.target.result).width(80).height(80);
            };
            reader.readAsDataURL(input.files[0]);
        }
    }
...
<script type="text/javascript">
    function extraimg2(input) {
        if (input.files && input.files[0]) {
            var reader = new FileReader();
            reader.onload = function(e) {
                $('#image_two_preview').attr('src', e.target.result).width(80).height(80);
            };
            reader.readAsDataURL(input.files[0]);
        }
    }
...
<script type="text/javascript">
    function extraimg3(input) {
        if (input.files && input.files[0]) {
            var reader = new FileReader();
            reader.onload = function(e) {
                $('#image_three_preview').attr('src', e.target.result).width(80).height(80);
            };
            reader.readAsDataURL(input.files[0]);
        }
    }
...
<script type="text/javascript">
    function extraimg4(input) {
        if (input.files && input.files[0]) {
            var reader = new FileReader();
            reader.onload = function(e) {
                $('#image_four_preview').attr('src', e.target.result).width(80).height(80);
            };
            reader.readAsDataURL(input.files[0]);
        }
    }
